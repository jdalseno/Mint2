...
void DalitzPdfBaseFlexiFastInteg::doFinalStatsAndSave(Minimiser* mini0,const std::string& fname, const std::string& fnameROOT){
    _faint.doFinalStatsAndSave(mini0,fname,fnameROOT);
}
